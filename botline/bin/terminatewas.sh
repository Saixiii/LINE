...
##  Date:           11/08/2015
##  Function:       Terminate websphere instance server
##===============================================================================##
...
WAS_FILE=${WAS_PATH}/LineterminateWas.py
WAS_USER=msoc
WAS_PASS=msoc
...
disown
echo "Process is running terminate ${WAS_SERVER}"