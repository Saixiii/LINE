...
public class bot_display_bar {
	...
	private static String field[] = {"IMSI","HLRSN","CardType","NAM","CATEGORY","ODBIC","ODBOC","BAOC","BAIC","BAOC","BAIC","NAM"};
	// Usage java
	public static void Usage() {
		System.out.println("Usage: java displayHLRRMV 66XXXXXXXX       --> Single");
		System.out.println("Usage: java displayHLRRMV <FileName>.lst   --> Batch");
		System.exit(0);
	}
	...
	public static String MMLdisplay (BufferedReader mslist) {
		...
		try {
			...
			if(login.equals("0")) {
				...
				System.out.println(",U-CSI,O-CSI");
				...
				while ((msisdn = mslist.readLine())!= null) {
					...
					if(discode.equals("0")) {
						...
						System.out.println("," + ucsname + "," + ocsname);
					} else {
