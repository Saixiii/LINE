...
public class disHLRRMVODB {
	
	
	private static String host = "10.95.20.68";
	private static int port = 7776;
	private static String user = "amhlrrbf";
	private static String pass = "amhllRBF";
	
	// Define field query parameter
	private static String field[] = {"IMSI","CardType","NAM","ODBSS","ODBOC","ODBIC","ODBENTE","ODBINFO","ODBROAM","ODBRCF","ODBECT","ODBPOS","ODBPOSTYPE","plmn-specificSS-3","plmn-specificSS-4","plmn-specificSS-9","plmn-specificSS-A"};
	
	
	// Usage java
	public static void Usage() {
		System.out.println("Usage: dis hlrrmvlu 66XXXXXXXX");
		System.exit(0);
	}
